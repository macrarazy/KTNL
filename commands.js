...
var commands = exports.commands = {
	...
	redir: function (target, room, user, connection) {
		...
		if (!this.can('lock', targetUser, room) || !this.can('redirect', targetUser, targetRoom)) return false;
		if (!targetUser || !targetUser.connected) {
	...
	declare: function (target, room, user) {
		...
		this.add('|raw|<div class="broadcast-blue"><b><font size=1><i>Declare by "' + user.name + '"</i></font><br /><font size=2>' + Tools.escapeHTML(target) + '</font></b></div>');
